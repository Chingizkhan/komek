...
type (
	...
	Cache interface {
		SetDonorsQuantityByFundraiseID(ctx context.Context, fundraiseID uuid.UUID) (int, error)
		GetDonorsQuantityByFundraiseID(ctx context.Context, fundraiseID uuid.UUID) (int, error)
	}
)
